...
python $TAGGERPATH/tagger/bin/trainer.py \
  ...
  --parameters="save_summary=false,"`
               ...
               `"batch_size=2048,buffer_size=10240,num_hidden_layers=12,train_steps=600000,"`
               `"relu_dropout=0.15,residual_dropout=0.15,attention_dropout=0.15,lstm_dropout=0.15,"`
               ...
               `"learning_rate_values=[1.0,0.5,0.25,0.01],learning_rate_boundaries=[400000,470000,54000],"`
